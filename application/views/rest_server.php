...
<div id="container">
    ...
    <div id="body">
        ...
        <ol>
            <li><a href="<?php echo site_url('maskapai'); ?>">Maskapai</a> - Kumpulam Data Maskapai</li>
            <li><a href="<?php echo site_url('penumpang'); ?>">Penumpang</a> - Daftar Penumpang</li>
            <li><a href="<?php echo site_url('penerbangan'); ?>">Penerbangan</a> - Jadwal Penerbangan</li>
            <li><a href="<?php echo site_url('tiket'); ?>">Tiket</a> - All Transaksi</li>
        </ol>
